...
namespace IronPainter
{
    public partial class FormEditorGameTrain : Form
    {
        ...
        {
            PictureBox[] pictures = {pictureBoxOssetianTrain,pictureBoxArmenianTrain,pictureBoxGeorgianTrain,pictureBoxOssetian,pictureBoxArmenian,pictureBoxGeorgian,pictureBoxRussianTrain };
            for (int i = 0; i < pictures.Length; i++)
            {
